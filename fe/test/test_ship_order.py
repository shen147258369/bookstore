...
class TestSend:
    ...
    def pre_run_initialization(self):
        self.seller_id = "test_shiporder_seller_id_{}".format(str(uuid.uuid1()))
        self.confuse_seller_id = "test_shiporder_confuse_seller_id_{}".format(str(uuid.uuid1()))
        self.store_id = "test_shiporder_store_id_{}".format(str(uuid.uuid1()))
        self.buyer_id = "test_shiporder_buyer_id_{}".format(str(uuid.uuid1()))
    ...
    def test_wrong_order(self):
        ...
        code,massge = self.seller.ship_order(self.seller_id, self.store_id, self.order_id)
        assert code != 200
